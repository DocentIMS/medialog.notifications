...
from medialog.notifications.testing import (
    MEDIALOG_NOTIFICATIONS_INTEGRATION_TESTING,
)  # noqa: E501
...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.is_product_installed("medialog.notifications"))
    ...
    def test_browserlayer(self):
        ...
        self.assertIn(IMedialogNotificationsLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.is_product_installed("medialog.notifications"))
